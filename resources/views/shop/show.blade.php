                            ...
                            <div class="product-thumbs-tracks ps-slider owl-carousel">
                                ...
                                @foreach($product ->productImages as $productImage)
                                    <div class="pt active"
                                        ...
                                        <img src="public/frontend/img/products/{{ $productImage->path }}" alt=""></div>
                                @endforeach
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="specification-table">
                                <table>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @foreach(array_unique(array_column($product->productDetail->toArray(),'size')) as $productColor)
                                                {{$productColor}}
                                            @endforeach</td>
                                        <td>
                                    ...
                                    <div class="co-item">
                                        @foreach($product ->productComments as $productComment)
                                            <div class="avatar-pic">
                                                <img src="public/frontend/img/user{{$productComment->user->avatar ?? 'default-avatar.jpg'}}"
                                                     alt="">
                                            </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-3 col-sm-6">
                <div class="product-item">
                    <div class="pi-pic">
                        <img src="public/frontend/img/products/{{$relatedProduct->productImages[0]->path}}" alt="">
