...
<form action="{{request()-> segment(2) == 'product' ? 'shop' : ''}}">
    ...
    <div class="filter-widget"> {{--// lọc danh sách sản phẩm theo giá tiền--}}
    ...
    <div class="filter-widget">
        ...
        <div class="fw-color-choose">
            ...
            <div class="cs-item">
                <input type="radio" id="cs-violet" name="color" value="violet" onchange="this.form.submit();"  name="color" value="" onchange="this.form.submit();"
